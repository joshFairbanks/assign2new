...
*   **Fully responsive gallery and Mobile features** - advanced responsive gallery. Gallery implemented with advanced settings for different devices screen size.
...
*   **Video Gallery Links** - in gallery media manager every image have separate option for video gallery link. Video Gallery links could be specified to to the youtube or vimeo.
...
*   **Tags for gallery images** - every gallery image contain description field. In additional parameters of the gallery image hover you can define some HTML or tags or build-in tags for customization of the gallery image description.
